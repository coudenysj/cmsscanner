...
class MsdAdapter implements AdapterInterface
{
    ...
    private $versions = array(
        array(
            "file" => "/inc/runtime.php",
            "regex" => '~define\(\'MSD_VERSION\',\s*\'(.+)\'~',
        ),
    );

    /**
     * Msd has a file called configuration.php that can be used to search for working installations
     *
    ...
    /**
     * determine version of a Msd installation within a specified path
     *
